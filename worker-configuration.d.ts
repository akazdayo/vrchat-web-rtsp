/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env .env.prod` (hash: baf0b106bfd84f8ea764d0778750b866)
...
declare namespace Cloudflare {
	...
	interface Env {
		VITE_WHIP_ENDPOINT: string;
		VITE_MEDIAMTX_OUTPUT_URL: string;
		VITE_SITE_KEY: string;
		TURNSTILE_SECRET_KEY: string;
		ROOM: DurableObjectNamespace<import("./src/server").Room>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_WHIP_ENDPOINT" | "VITE_MEDIAMTX_OUTPUT_URL" | "VITE_SITE_KEY" | "TURNSTILE_SECRET_KEY">> {}
}
